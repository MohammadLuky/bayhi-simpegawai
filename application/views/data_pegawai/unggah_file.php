                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-content collapse show">
                                <form action="<?= base_url('datapegawai/unggah_berkas') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row justify-content-end">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <?php if (!empty($file_pegawai['file_kk_pdf']) && !empty($file_pegawai['file_ktp_pdf'])): ?>
                                                    <a href="<?= base_url('datapegawai/hapus_berkas') ?>" data-toggle="tooltip" data-placement="top" title="Edit File Pegawai" class="btn btn-warning btn-sm btn-round"><i class="fas fa-edit"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card mb-1 border-top-amber border-top-darken-3 border-top-5">
                                                        <div class="card-content">
                                                            <div class="p-1">
                                                                ...
                                                                <div class="mb-2">
                                                                    <input class="form-control" type="file" id="peg_kk" name="peg_kk" accept=".pdf">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card mb-1 border-top-amber border-top-darken-3 border-top-5">
                                                        <div class="card-content">
                                                            <div class="p-1">
                                                                ...
                                                                <div class="mb-2">
                                                                    <input class="form-control" type="file" id="peg_ktp" name="peg_ktp" accept=".pdf">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
