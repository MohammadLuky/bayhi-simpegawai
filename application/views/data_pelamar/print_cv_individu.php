    ...
    <div class="card mt-2">
      ...
      <div class="card-body">
        ...
        <div style="margin-bottom: 20px; margin-top: 1px;">
          <table class="table table-striped">
            <tr>
              <td style="width: 10%;">
                <img src="<?= base_url('assets/file_foto/'); ?><?= $individu['foto']; ?>" alt="..." width="150" height="215">
              </td>
              <td style="width: 90%;">
                <span style="font-size: 11pt;"><strong><?= strtoupper($individu['nama_lengkap']); ?></strong></span><br>
                <?php if ($individu['role_id'] != 8) : ?>
                  <span style="font-size: 9pt;"><?= strtoupper($individu['ket_role']); ?> | <?= strtoupper($individu['nama_unit']); ?></span>
                <?php elseif ($individu['role_id'] == 8) : ?>
                  <span style="font-size: 9pt;"><?= strtoupper($individu['ket_role']); ?>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <span style="font-size: 9pt;"><?= strtoupper($individu['tempat_lahir']); ?>, <?= tanggal_indonesia_format($individu['tanggal_lahir']); ?></span>
                  </div>
                  <div class="col-sm-6">
                    <span style="font-size: 11pt;"><strong>Jenis Kelamin</strong></span><br>
                    <span style="font-size: 9pt;"><?= strtoupper($individu['jenis_kelamin']); ?></span>
                  </div>
                </div>
                <hr>
                <span style="font-size: 11pt;"><strong>Alamat KTP</strong></span><br>
                <span style="font-size: 9pt;"><?= strtoupper($individu['alamat']); ?> KELURAHAN <?= $individu['nama_kelurahan_pelamar']; ?> KECAMATAN <?= $individu['nama_kecamatan_pelamar']; ?> <?= $individu['nama_kotakab_pelamar']; ?></span>
                <hr>
                <span style="font-size: 11pt;"><strong>Alamat Domisili</strong></span><br>
                <span style="font-size: 9pt;"><?= strtoupper($individu['alamat_domisili']); ?> KELURAHAN <?= $individu['nama_kelurahan_domisili']; ?> KECAMATAN <?= $individu['nama_kecamatan_domisili']; ?> <?= $individu['nama_kotakab_domisili']; ?></span>
                <hr>
                <div class="row">
                  <div class="col-sm-6">
                    <span style="font-size: 11pt;"><strong>Agama</strong></span><br>
                    <span style="font-size: 9pt;"><?= strtoupper($individu['nama_agama']); ?></span>
                  </div>
                  <div class="col-sm-6">
                    <span style="font-size: 11pt;"><strong>Status Perkawinan</strong></span><br>
                    <span style="font-size: 9pt;"><?= strtoupper($individu['status_perkawinan']); ?></span>
                  </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <span style="font-size: 9pt;"><?= strtoupper($individu['no_wa_telp']); ?></span>
                  </div>
                  <div class="col-sm-6">
                    <span style="font-size: 11pt;"><strong>Email Aktif</strong></span><br>
                    <span style="font-size: 9pt;"><?= strtoupper($individu['email_pegawai']); ?></span>
                  </div>
                </div>
              </td>
            </tr>
      ...
      <div class="card-footer">
        <div class="row">
          ...
          <div class="col-auto"><?= $title; ?> | <strong><?= $individu['nama_lengkap']; ?></strong> | <?= $individu['ket_role']; ?> | <?= $individu['nama_unit']; ?></div>
        </div>
      </div>
